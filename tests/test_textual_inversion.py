...
class DummyTransformer:
    def __init__(self):
        self.embeddings = DummyEmbeddingsList(
            [make_dummy_embedding() for _ in range(len(KNOWN_WORDS))]
        )
...
def was_embedding_overwritten_correctly(
    tim: TextualInversionManager,
    overwritten_embedding: torch.Tensor,
    ti_indices: list,
    ti_embedding: torch.Tensor,
) -> bool:
    return torch.allclose(
        overwritten_embedding[ti_indices],
        ti_embedding + tim.clip_embedder.position_embedding(ti_indices),
    )


def make_dummy_textual_inversion_manager():
    return TextualInversionManager(
        tokenizer=DummyTokenizer(), text_encoder=DummyTransformer()
    )
...
class TextualInversionManagerTestCase(unittest.TestCase):
    ...
    def test_add_embedding_for_known_token(self):
        ...
        self.assertFalse(
            tim.has_textual_inversion_for_trigger_string(test_embedding_name)
        )
        ...
        textual_inversion = tim.get_textual_inversion_for_trigger_string(
            test_embedding_name
        )
    ...
    def test_add_embedding_for_unknown_token(self):
        ...
        added_token_id_1 = tim._add_textual_inversion(
            test_embedding_name_1, test_embedding_1
        ).trigger_token_id
        ...
        # check it was added
        self.assertTrue(
            tim.has_textual_inversion_for_trigger_string(test_embedding_name_1)
        )
        textual_inversion = next(
            ti
            for ti in tim.textual_inversions
            if ti.trigger_token_id == added_token_id_1
        )
        self.assertIsNotNone(textual_inversion)
        ...
        added_token_id_2 = tim._add_textual_inversion(
            test_embedding_name_2, test_embedding_2
        ).trigger_token_id
        ...
        # check it was added
        self.assertTrue(
            tim.has_textual_inversion_for_trigger_string(test_embedding_name_2)
        )
        textual_inversion = next(
            ti
            for ti in tim.textual_inversions
            if ti.trigger_token_id == added_token_id_2
        )
        self.assertIsNotNone(textual_inversion)
    ...
    def test_pad_raises_on_eos_bos(self):
        tim = make_dummy_textual_inversion_manager()
        prompt_token_ids_with_eos_bos = (
            [tim.tokenizer.bos_token_id]
            + [KNOWN_WORDS_TOKEN_IDS]
            + [tim.tokenizer.eos_token_id]
        )
        with self.assertRaises(ValueError):
            tim.expand_textual_inversion_token_ids_if_necessary(
                prompt_token_ids=prompt_token_ids_with_eos_bos
            )
    ...
    def test_pad_tokens_list_vector_length_1(self):
        ...
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
        ...
        test_embedding_1v_token_id = tim._add_textual_inversion(
            test_embedding_1v_token, test_embedding_1v
        ).trigger_token_id
        ...
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_1v_append
        )
        ...
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_1v_prepend
        )
        self.assertEqual(prompt_token_ids_1v_prepend, expanded_prompt_token_ids)

        # in the middle
        prompt_token_ids_1v_insert = (
            prompt_token_ids[0:2] + [test_embedding_1v_token_id] + prompt_token_ids[2:3]
        )
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_1v_insert
        )
    ...
    def test_pad_tokens_list_vector_length_2(self):
        ...
        test_embedding_2v_token_id = tim._add_textual_inversion(
            test_embedding_2v_token, test_embedding_2v
        ).trigger_token_id
        test_embedding_2v_pad_token_ids = tim.get_textual_inversion_for_token_id(
        ...
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_2v_append
        )
        ...
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_2v_prepend
        )
        ...
        prompt_token_ids_2v_insert = (
            prompt_token_ids[0:2] + [test_embedding_2v_token_id] + prompt_token_ids[2:3]
        )
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_2v_insert
        )
    ...
    def test_pad_tokens_list_vector_length_8(self):
        ...
        test_embedding_8v_token_id = tim._add_textual_inversion(
            test_embedding_8v_token, test_embedding_8v
        ).trigger_token_id
        test_embedding_8v_pad_token_ids = tim.get_textual_inversion_for_token_id(
        ...
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_8v_append
        )
        ...
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_8v_prepend
        )
        ...
        prompt_token_ids_8v_insert = (
            prompt_token_ids[0:2] + [test_embedding_8v_token_id] + prompt_token_ids[2:3]
        )
        expanded_prompt_token_ids = tim.expand_textual_inversion_token_ids_if_necessary(
            prompt_token_ids=prompt_token_ids_8v_insert
        )
    ...
    def test_deferred_loading(self):
        ...
        ti = tim._add_textual_inversion(
            test_embedding_name, test_embedding, defer_injecting_tokens=True
        )
