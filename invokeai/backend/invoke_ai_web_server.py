...
from ldm.invoke.conditioning import get_prompt_structure, get_tokens_for_prompt
...
from ldm.invoke.prompt_parser import Blend, split_weighted_subprompts
        ...
        try:
            ...
            def image_done(image, seed, first_seed, attention_maps_image=None):
                ...
                tokens = (
                    ...
                    else get_tokens_for_prompt(self.generate.model, parsed_prompt)
                )
