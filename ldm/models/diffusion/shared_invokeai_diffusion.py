...
class InvokeAIDiffuserComponent:
    ...
    * Hybrid conditioning (used for inpainting)
    ...
    def __init__(
        self,
        model,
        model_forward_callback: Callable[
    ...
    def do_diffusion_step(
        ...
        if wants_hybrid_conditioning:
            unconditioned_next_x, conditioned_next_x = self.apply_hybrid_conditioning(
            ...
            (
                ...
                conditioned_next_x,
            ) = self.apply_cross_attention_controlled_conditioning(
                x,
                sigma,
                unconditioning,
                conditioning,
            ...
            unconditioned_next_x, conditioned_next_x = self.apply_standard_conditioning(
                x, sigma, unconditioning, conditioning
            )
    ...
    def apply_cross_attention_controlled_conditioning(
        self,
        x: torch.Tensor,
        sigma,
        unconditioning,
        ...
        if self.is_running_diffusers:
            return self.apply_cross_attention_controlled_conditioning__diffusers(
                x,
                sigma,
                unconditioning,
                conditioning,
            ...
            return self.apply_cross_attention_controlled_conditioning__compvis(
                x,
                sigma,
                unconditioning,
                conditioning,
    ...
    def apply_cross_attention_controlled_conditioning__diffusers(
        self,
        x: torch.Tensor,
        sigma,
        unconditioning,
    ...
    def apply_cross_attention_controlled_conditioning__compvis(
        self,
        x: torch.Tensor,
        sigma,
        unconditioning,
